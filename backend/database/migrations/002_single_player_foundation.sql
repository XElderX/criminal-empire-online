...
ALTER TABLE users ADD COLUMN dirty_money BIGINT UNSIGNED NOT NULL DEFAULT 0 AFTER bank_cash;
ALTER TABLE users ADD COLUMN reputation INT NOT NULL DEFAULT 0 AFTER heat;
ALTER TABLE users ADD COLUMN home_territory_id BIGINT UNSIGNED NULL AFTER leadership;

ALTER TABLE territories ADD COLUMN unemployment INT NOT NULL DEFAULT 20;
ALTER TABLE territories ADD COLUMN police_presence INT NOT NULL DEFAULT 50;
ALTER TABLE territories ADD COLUMN drug_demand INT NOT NULL DEFAULT 50;
ALTER TABLE territories ADD COLUMN weapon_demand INT NOT NULL DEFAULT 40;
ALTER TABLE territories ADD COLUMN entertainment_demand INT NOT NULL DEFAULT 50;
ALTER TABLE territories ADD COLUMN rent_level INT NOT NULL DEFAULT 50;
ALTER TABLE territories ADD COLUMN corruption_level INT NOT NULL DEFAULT 20;
ALTER TABLE territories ADD COLUMN public_fear INT NOT NULL DEFAULT 10;
