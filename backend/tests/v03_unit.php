...
$runner->test('Version is v0.4.0', function () use ($runner): void {
    $runner->assertSame('0.4.0', GameConfig::VERSION);
});

$runner->test('Release title identifies Crimes Expansion update', function () use ($runner): void {
    $runner->assertContains('Crimes Expansion', GameConfig::RELEASE_TITLE);
});
