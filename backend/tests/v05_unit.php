...
$runner->test('Version is v0.5.0', function () use ($runner): void {
    $runner->assertSame('0.5.0', GameConfig::VERSION);
});

$runner->test('Release title identifies Heat & Police expansion', function () use ($runner): void {
    $runner->assertContains('Heat & Police Pressure Expansion', GameConfig::RELEASE_TITLE);
});
